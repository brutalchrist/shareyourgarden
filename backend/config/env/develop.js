    ...
    ***************************************************************************/
    default: {
      ...
      ****************************************************************************/
      // ssl: true,
        adapter: 'sails-mongo',
        host: '172.16.231.2', // defaults to `localhost` if omitted 
        port: 27017, // defaults to 27017 if omitted 
        user: 'shareyourgarden', // or omit if not relevant 
        password: 'shareyourgarden', // or omit if not relevant 
        database: 'shareyourgarden' // or omit if not relevant 
    },
